## 🖥️ **Software Engineer & Team Lead** | .NET, Angular, Cloud  
...
- **Cloud Services:** AWS (EC2, RDS, S3, CloudFront, MQ, SES, SNS, Lambda, Route53, IAM, Elastic Beanstalk, VPC), Azure (B2C auth, App Insights, Key Vault, Blob Storage, Container Registry), GitHub, GitLab, Firebase
- **Additional Skills:** UI/UX Design, AI Tools and Agents (Copilot, Cursor, Google AI Studio, Note), Communication, Management, Microservices, Scrum, Kanban, Jira, Asana
